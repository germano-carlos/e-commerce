          ...
          <div>
            <b-breadcrumb>
              ...
              <b-breadcrumb-item href="#foo"
                >Clientes Cadastrados</b-breadcrumb-item
              >
            </b-breadcrumb>
          </div>

          <b-card footer-tag="footer" title="Gestão de Clientes">
            <b-card-text
              >Bem vindo a área gerencial do seu e-commerce. Abaixo você
              conseguirá visualizar as telas na qual será possível gerenciar as
              informações relacionadas à clientes.
              <p></p>
            </b-card-text>
          </b-card>
        </div>
...
import Table from "../../components/admin/ClientsTable.vue";
...
export default {
  ...
  methods: {
    listarClientes: async function () {
      await WorkAPI.Auth.listarClientes(
        null,
        (data) => {

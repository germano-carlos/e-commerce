                ...
                <tbody v-if="cart.length > 0">
                  <tr v-for="(cart, i) in cart" :key="i">
                    ...
                    <td class="product-name">
                      ...
                      <ul>
                        <li>Cor: <strong>Azul claro</strong></li>
                        <li>Tamanho: <strong>43</strong></li>
                        <li>Material: <strong>Algodão</strong></li>
                      </ul>
                    </td>

                    <td class="product-price">
                      <span class="unit-amount">R$ {{ cart.price }}</span>
                    </td>
                    ...
                    <td class="product-subtotal">
                      <span class="subtotal-amount"
                        >R$ {{ cart.price * cart.quantity }}</span
                      >
                  ...
                  <div class="cart-totals">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <span
                          ><b
                            >R$ {{ parseFloat(cartTotal + 10).toFixed(2) }}</b
                          ></span
                        >
                      </li>
                    </ul>
                    <nuxt-link to="/checkout" class="btn btn-light"
                      >Fazer o check-out</nuxt-link
                    >
                  </div>
                </div>
              </div>
